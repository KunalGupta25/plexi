...
if "api_key" not in st.session_state:
    ...
    if api_key:
        ...
        st.rerun()  # Rerun to hide the field
    else:
...
# Step 3: Set up embedding and LLM with user-provided API key
...
def init_chat_engine():
    ...
    return index.as_chat_engine(
        ...
        system_prompt=(
            ...
            "your name is plexi."
            "You have access to a knowledge base of study materials of many semesters so always ask if you are not sure which semester study materialsto use. "
